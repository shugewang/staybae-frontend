  ...
  return (
    <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5'>
        ...
        <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm hover:shadow-md">
            ...
            <input type="text" name="search" id="searchId" className='flex-grow pl-5 bg-transparent outline-none text-sm text-gray-600 placeholder-gray-400' 
                value={searchTerm}
        ...
        <div className="flex space-x-4 items-center justify-end" onClick={() => props.setIsShowFavourites(true)} >
      ...
      {searchTerm && (
        <div className="flex flex-col col-span-3 mx-auto">
            ...
            <div className="flex items-center border-b mb-4">
                ...
                <input type="number" id="numberOfGuestsId" min={1} value={numberOfGuests}
                onChange={(e) => setNumberOfGuests(e.target.value as unknown as number)} 
